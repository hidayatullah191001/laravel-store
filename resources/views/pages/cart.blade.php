        ...
        <section class="store-cart">
            <div class="container">
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    @if ($carts->count() < 1)
                        <div class="col-12 text-center mt-5">
                            <img src="/images/success.svg" alt="" style="max-width : 200px">
                            <h2>Keranjang kamu kosong!</h2>
                            <p>
                                Sepertinya kamu belum memasukkan barang apapun kedalam keranjang kamu.
                                Ayo belanja sekarang, murah dan mudah!
                            </p>
                            <div>
                                <a href="{{ route('home') }}" class="btn btn-success w-20 mt-2">Go To Shopping</a>
                            </div>
                        </div>
                    @else
                ...
                <form action="{{ route('checkout') }}" id="locations" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row mb-2" data-aos="fade-up" data-aos-delay="120">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="phone_number" name="phone_number"
                                    value="{{ Auth::user()->phone_number ?? '' }}" placeholder="+628 993-489" />
                            </div>
                        </div>
                    </div>
                    <div class="row" data-aos="fade-up" data-aos-delay="150">
